...
| Layer 2 Solution | Linea for scalability and low fees |
...
| Initial Circulating Supply | 1,000,000 SWHIT (0.2% of total supply) |
...
| Task | Reward |
|------|--------|
| Creating an account | 10 SWHIT |
| Completing profile | 20 SWHIT |
| Daily login | 5 SWHIT |
| Sharing content about Wheat-Sol | 15 SWHIT per share |
| Referring new users | 50 SWHIT per verified referral |
| Participating in community discussions | 1 SWHIT per quality post |
| Completing educational modules | 25 SWHIT per module |
| Contributing to development (e.g., bug reports) | 100-1000 SWHIT based on impact |
